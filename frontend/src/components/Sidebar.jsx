...
function Icon({ name, className = "w-4 h-4" }) {
  const icons = {
    dashboard: (
      <path d="M3 12h8V3H3v9zm0 9h8v-7H3v7zm10 0h8V12h-8v9zm0-18v7h8V3h-8z" />
    ),
    catalog: (
      <path
    ...
    orders: (
      <path
        d="M6 3h12l3 5v13a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zm0 0v16m12-16v16M9 8h6"
        stroke="currentColor"
        strokeWidth="2"
        fill="none"
      />
    ...
    schedule: (
      <path
        d="M7 2v4M17 2v4M3 10h18M5 6h14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2z"
        stroke="currentColor"
        strokeWidth="2"
        fill="none"
      />
    ...
    pricing: (
      <path
        d="M12 1v22M7 5h5a4 4 0 0 1 0 8H9a4 4 0 0 0 0 8h7"
        stroke="currentColor"
        strokeWidth="2"
        fill="none"
      />
    ...
    reports: (
      <path
        d="M4 4h16v16H4zM8 14v4M12 10v8M16 6v12"
        stroke="currentColor"
        strokeWidth="2"
        fill="none"
      />
